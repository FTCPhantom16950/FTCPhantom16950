...
import org.firstinspires.ftc.teamcode.own.actions.util.CameraColorAction;
...
@TeleOp
public class MainTeleOpBlue extends PhantomOpMode {
    @Override
    public void customOpModeSettings() throws InterruptedException {
        ...
        Robot.INSTANCE.setStartAction(new ParallelGroup(
                new CameraColorAction(),
                new StandingGamepad(),
                new RotateLongAction(false),
                new CaptureGamepad(),
