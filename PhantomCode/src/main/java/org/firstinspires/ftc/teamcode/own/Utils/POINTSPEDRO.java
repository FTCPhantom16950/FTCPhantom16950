...
public class POINTSPEDRO {
    ...
    public static final Pose startPosetoSpiceman = new Pose(134.8, 72.9, Math.toRadians(0));
    ...
    public static final Pose toSpiceman1Control1 = new Pose(142.4, 68.2);
    public static final Pose toSpiceman1Control2 = new Pose(141.1, 136.1);
    public static final Pose toSpiceman1Control3 = new Pose(68.7,95.3);
